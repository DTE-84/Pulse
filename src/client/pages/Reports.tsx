    ...
    <div className="p-8 md:p-12 max-w-7xl mx-auto space-y-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-3">
          <h1 className="text-5xl font-black tracking-tighter text-foreground">Financial Reports</h1>
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-3 bg-muted border border-border px-6 py-3 rounded-full text-[10px] font-black transition-all hover:bg-muted uppercase tracking-widest text-muted-foreground group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-4 bg-card border border-border rounded-[2.5rem] p-10 space-y-12">
           <div className="flex items-center justify-between">
              <h3 className="text-xl font-black text-foreground uppercase tracking-tighter">7-Day Velocity Chart</h3>
        ...
        <div className="lg:col-span-3 space-y-8">
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             {[
               ...
               <div key={i} className="bg-card border border-border rounded-3xl p-8 space-y-4 hover:bg-muted/50 transition-all cursor-pointer group">
           ...
           <div className="bg-card border border-border rounded-[2.5rem] p-10 space-y-10">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-black text-foreground uppercase tracking-tighter">AI Behavioral Synthesis</h3>
              ...
              <div className="space-y-6">
                <div className="flex gap-6 p-8 rounded-[2rem] bg-primary/5 border border-primary/10 hover:bg-primary/10 transition-all group cursor-pointer relative overflow-hidden">
                  ...
                  <div className={cn("w-14 h-14 rounded-2xl bg-muted flex items-center justify-center shrink-0 shadow-inner group-hover:scale-110 transition-transform text-primary")}>
                     <BrainCircuit className="w-8 h-8" />
                  </div>
                  <div className="space-y-2">
                     <h4 className="text-lg font-black text-foreground leading-none">Nova Deep-Scan Report</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                   <div className="p-6 rounded-3xl bg-white/[0.01] border border-border">
                      ...
                      <div className="flex items-center gap-3">
                         ...
                         <div>
                            <div className="text-base font-bold text-foreground">{analysis?.summary?.topTrigger || "None Detected"}</div>
                   ...
                   <div className="p-6 rounded-3xl bg-white/[0.01] border border-border">
                      ...
                      <div className="flex items-center gap-3">
                         ...
                         <div>
                            <div className="text-base font-bold text-foreground">{analysis?.summary?.acceleration === "Detected" ? "ACCELERATING" : "STABLE"}</div>
        ...
        <div className="lg:col-span-1 space-y-6 flex flex-col h-full">
           <div className="bg-card border border-border rounded-[2.5rem] p-8 space-y-8 flex-1 flex flex-col text-center">
             ...
             <div className="space-y-2">
                <h3 className="text-2xl font-black text-foreground">Nova Advisor</h3>
