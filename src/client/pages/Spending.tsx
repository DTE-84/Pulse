  ...
  return (
    <div className="p-4 sm:p-8 md:p-12 max-w-7xl mx-auto space-y-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground font-semibold text-lg max-w-lg leading-snug">
            You've spent <span className="text-white">$3,240</span> this month,{" "}
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="relative group">
            ...
            <input
              ...
              className="bg-white/5 border border-white/5 pl-12 pr-6 py-3 rounded-full text-xs font-bold text-white focus:outline-none focus:border-primary/30 transition-all w-full sm:w-64"
            />
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 bg-[#12110F] border border-white/5 rounded-[2rem] sm:rounded-[2.5rem] p-5 sm:p-10 space-y-8 flex flex-col items-center justify-center">
        ...
        {/* Transactions List */}
        <div className="lg:col-span-2 bg-[#12110F] border border-white/5 rounded-[2rem] sm:rounded-[2.5rem] p-5 sm:p-10 space-y-6 sm:space-y-10">
          ...
          <div className="space-y-4">
            {transactions.map((tx) => {
              ...
              return (
                <div
                  key={tx.transaction_id}
                  className="group flex items-center justify-between p-5 rounded-3xl hover:bg-white/[0.03] border border-transparent hover:border-white/5 transition-all"
                >
                  <div className="flex items-center gap-5 flex-1">
                    <div
                      className={cn(
                        "w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center group-hover:scale-105 transition-transform text-primary",
                      )}
                    >
                      <Icon className="w-7 h-7" />
                    </div>
                    <div className="overflow-hidden">
                      <div className="text-base font-bold text-white mb-0.5 truncate">
                        {tx.merchant_name || tx.category_name}
                      </div>
                  ...
                  <div className="flex flex-col items-end gap-3 shrink-0 ml-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent
                          align="end"
                          className="bg-[#12110F] border-white/10 text-white w-48"
                        >
          ...
          <div className="bg-primary/5 border border-primary/10 rounded-3xl p-6 flex flex-col md:flex-row items-center justify-between gap-6 group cursor-pointer hover:bg-primary/10 transition-all">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-base font-bold text-white group-hover:text-primary transition-colors italic leading-snug">
