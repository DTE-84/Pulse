...
export const handleStats = (req, res) => {
    ...
    if (behavioralScore > 2.5)
        user.novaTone = "Aggressive";
    else if (behavioralScore > 0 && behavioralScore < 1.5)
        user.novaTone = "Conservative";
    else
        user.novaTone = "Balanced";
    const now = new Date();
