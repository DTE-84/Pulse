...
import { ChevronRight, Download, TrendingUp, Zap, ArrowUpRight, ArrowDownRight, Flame, CheckCircle2, Sparkles, ArrowRight } from "lucide-react";
...
export default function ReportsPage() {
    ...
    return (<div className="p-8 md:p-12 max-w-7xl mx-auto space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
           ...
           <div className="h-80 w-full mt-6">
             <ResponsiveContainer width="100%" height="100%">
               <BarChart data={performanceData}>
                 ...
                 <YAxis hide/>
                 <Tooltip cursor={{ fill: 'rgba(255,255,255,0.02)' }} contentStyle={{ backgroundColor: '#1A1917', border: 'none', borderRadius: '1.5rem', padding: '1.5rem', boxShadow: '0 20px 40px rgba(0,0,0,0.5)' }}/>
        ...
        ].map((stat, i) => (<div key={i} className="bg-[#12110F] border border-white/5 rounded-3xl p-8 space-y-4 hover:bg-[#1A1917] transition-all cursor-pointer group">
        ...
        ].map((insight, i) => (<div key={i} className="flex gap-6 p-6 rounded-3xl bg-white/[0.01] border border-white/5 hover:bg-white/[0.03] transition-all group cursor-pointer">
